...
class Operator(Packet):
    ...
    def part_two(self):
        if self.type_id == 0:
            return sum(c.part_two() for c in self.children)
        elif self.type_id == 1:
            result = 1
            ...
            return min(c.part_two() for c in self.children)
        elif self.type_id == 3:
            return max(c.part_two() for c in self.children)
        elif self.type_id == 5:
            if len(self.children) != 2:
                raise ValueError('Too many children for type 5')
            return 1 if self.children[0].part_two() > self.children[1].part_two() else 0
        elif self.type_id == 6:
            if len(self.children) != 2:
                raise ValueError('Too many children for type 6')
            return 1 if self.children[0].part_two() < self.children[1].part_two() else 0
        elif self.type_id == 7:
            if len(self.children) != 2:
                raise ValueError('Too many children for type 7')
            return 1 if self.children[0].part_two() == self.children[1].part_two() else 0
...
if __name__ == '__main__':
    ...
    print('result:', Packet.parse(source).part_two())
